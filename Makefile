...
SRCS = $(addprefix $(CUR_DIR)/srcs/, main.c built_in_echo.c built_in_env.c built_in_export.c built_in_pwd.c executer.c expander.c expander_utils.c helper_functions.c input_output.c parent_child_process.c run_built_in.c run_cmd.c)
