...
SRCS = $(addprefix $(CUR_DIR)/srcs/, built_in_cd.c built_in_echo.c built_in_env.c built_in_exit.c \
					...
					main.c parent_child_process.c parser_cmd_create_utils.c parser_cmd_utils.c parser_delete_utils.c \
					parser_redirections.c parser.c remove_full_quotes.c run_built_in.c run_cmd.c run_file.c)
